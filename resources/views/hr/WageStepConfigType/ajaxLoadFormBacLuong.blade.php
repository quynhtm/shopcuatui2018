    ...
    <div class="panel-body">
        <form id="formAdd" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="wage_step_config_value" title="Hệ số tương ứng" class="form-control input-required" id="wage_step_config_value" @if(isset($data['wage_step_config_value']))value="{{$data['wage_step_config_value']}}"@endif>
            </div>
            <div class="form-group">
            ...
            <a class="btn btn-success" id="submit" onclick="HR.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/wage-step-config-bac-luong/edit/' + '{{FunctionLib::inputId($data["wage_step_config_id"])}}')">
