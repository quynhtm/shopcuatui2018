    ...
    <div class="main-content-inner">
        <div class="breadcrumbs breadcrumbs-fixed top_nav" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li><a href="{{URL::route('admin.wardsView')}}"> {{viewLanguage('Quản Lý Xã')}}</a></li>
                    ...
                    <div style="float: left; width: 50%">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="wards_name"  class="form-control input-sm" value="@if(isset($data['wards_name'])){{$data['wards_name']}}@endif">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-12 text-left">
                            <a class="btn btn-warning" href="{{URL::route('admin.wardsView')}}"><i class="fa fa-reply"></i> {{viewLanguage('back')}}</a>
