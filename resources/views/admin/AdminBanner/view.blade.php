                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control input-sm" id="banner_name" name="banner_name"
                                       placeholder="Tên Video"
                                       @if(isset($search['banner_name']) && $search['banner_name'] != '')value="{{$search['banner_name']}}"@endif>
                            </div>
                            <div class="form-group col-lg-3">
                            ...
                            <div class="form-group col-lg-3">
                                <label for="category_status">Loại</label>
                            ...
                            <div class="form-group col-lg-12 text-right">
                                @if($is_root || $permission_full ==1 || $permission_create == 1)
                                    <a class="btn btn-danger btn-sm"
                                       href="{{URL::route('admin.bannerEdit',array('id' => FunctionLib::inputId(0)))}}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr class="">
                                    ...
                                    <th width="10%" class="text-center">Thông tin banner</th>
                                ...
                                @foreach ($data as $key => $item)
                                    ...
                                    <tr @if($item['parent_id'] == 0)style="background-color:#d6f6f6"@endif>
                                        ...
                                        <td>
                                            {!! isset($item['banner_name'])?$item['banner_name']:'' !!}
                                        </td>
                                        ...
                                        <td class="text-center text-middle">
                                            {!! isset($item['banner_start_time'])?$item['banner_start_time']:'' !!}
                                        </td>
                                        <td class="text-center text-middle">
                                        ...
                                        <td class="text-center text-middle">
                                            @if($is_root || $permission_full ==1|| $permission_edit ==1  )
                                                <a href="{{URL::route('admin.videoEdit',array('id' => FunctionLib::inputId($item['banner_id'])))}}"
                                                   title="Sửa item"><i class="fa fa-edit fa-2x"></i></a>
                                            @endif
                                            @if($is_boss)
                                                <a href="javascript:void(0);"
                                                   onclick="Admin.deleteItem({{$item['banner_id']}},17)" title="Xóa Item"><i
