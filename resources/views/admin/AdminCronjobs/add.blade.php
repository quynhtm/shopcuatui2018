        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div style="float: left; width: 50%">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="user_phone" title="(1:chạy ngày 1 lần, 2: chạy theo số lần config)"><i>Type cronjob</i></label>
                            <input type="text" class="form-control input-sm" id="cronjob_type" name="cronjob_type" autocomplete="off" placeholder="Type cronjob" @if(isset($data['cronjob_type']))value="{{$data['cronjob_type']}}"@endif>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="user_phone"><i>Ngày chạy</i></label>
                            <input type="text" class="form-control input-sm date" id="cronjob_date_run" name="cronjob_date_run" autocomplete="off" placeholder="Ngày chạy cronjob" @if(isset($data['cronjob_date_run']))value="{{date('d-m-Y H:i', $data['cronjob_date_run'])}}"@endif>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="user_phone"><i>Số lần đã chạy cronjob trong 1 ngày</i></label>
                            <input type="text" class="form-control input-sm" id="cronjob_number_running" name="cronjob_number_running" autocomplete="off" placeholder="Số lần đã chạy cronjob trong 1 ngày" @if(isset($data['cronjob_number_running']))value="{{$data['cronjob_number_running']}}"@endif>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="user_phone"><i>Kết quả trả ra của cronjob</i></label>
                            <input type="text" class="form-control input-sm" id="cronjob_result" name="cronjob_result" autocomplete="off" placeholder="Kết quả trả ra của cronjob" @if(isset($data['cronjob_result']))value="{{$data['cronjob_result']}}"@endif>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
