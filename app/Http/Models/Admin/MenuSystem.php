                ...
                foreach ($data as $menu) {
                    if ($menu['parent_id'] == 0) {
                        ...
                        if (isset($menuTree[$menu['parent_id']]['arr_link_sub'])) {
                            ...
                            $arrSub = array('menu_id' => $menu['menu_id'], 'show_menu' => $menu['show_menu'], 'name' => $menu['menu_name'], 'menu_tab_top_id' => $menu['menu_tab_top_id'], 'name_en' => $menu['menu_name_en'], 'RouteName' => $menu['menu_url'], 'icon' => $menu['menu_icons'] . ' icon-4x', 'showcontent' => $menu['showcontent'], 'permission' => '');
                            ...
                            $menuTree[$menu['parent_id']]['sub'] = array(
                                array('menu_id' => $menu['menu_id'], 'show_menu' => $menu['show_menu'], 'name' => $menu['menu_name'], 'menu_tab_top_id' => $menu['menu_tab_top_id'], 'name_en' => $menu['menu_name_en'], 'RouteName' => $menu['menu_url'], 'icon' => $menu['menu_icons'] . ' icon-4x', 'showcontent' => $menu['showcontent'], 'permission' => ''),);
                        }
                    }
                }
            }
